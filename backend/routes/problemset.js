...
router.get('/:id', async function(req, res, next) {
    ...
    try{
        const response1 = await axios.get('https://dataengineeringprojectarc.onrender.com/users/' + userName + '/miniarcs')
        const response2 = await axios.get('https://dataengineeringprojectarc.onrender.com/users/' + userName + '/arcs')
        data = response1.data
